...
def _run_split(process_idx, batch_size, num_processes, model_idx, special_dir="", split_choice="automatic"):
...
if __name__ == '__main__':
    ...
    p = Process(target=_run_split, args=(process_idx, batch_size, num_tenant, model_idx, f"multitenant_exp_{target}", split_choice))
    p.start()
    p.join()
